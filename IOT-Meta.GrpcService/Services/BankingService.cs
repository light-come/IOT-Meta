...
using Grpc.Core;
using IOT_Meta.GrpcService.Generated;
using Microsoft.Extensions.Logging;
using System;
using System.Text.Json;
using System.Threading.Tasks;

namespace IOT_Meta.GrpcService
{
    public class BankingService : AppCallback.AppCallbackBase//: Greeter.GreeterBase
    {
        ///// <summary>
        ...
        public override async Task<InvokeResponse> OnInvoke(InvokeRequest request, ServerCallContext context)
        {
            ...
            {
                case "getaccount":
                    var input = request.Data.Unpack<IOT_Meta.GrpcService.Generated.GetAccountRequest>();
                    var output = await GetAccount(input, context);
                    response.Data = Any.Pack(output);
                    break;
                case "deposit":
                case "withdraw":
                    var transaction = request.Data.Unpack<IOT_Meta.GrpcService.Generated.Transaction>();
        ...
        public override async Task<TopicEventResponse> OnTopicEvent(TopicEventRequest request, ServerCallContext context)
        {
            if (request.PubsubName == "pubsub")
            {
                ...
                var transaction = new IOT_Meta.GrpcService.Generated.Transaction() { Id = input.Id, Amount = (int)input.Amount, };
        ...
        public async Task<Account> GetAccount(GetAccountRequest input, ServerCallContext context)
        {
            ...
            return new IOT_Meta.GrpcService.Generated.Account() { Id = state.Value.Id, Balance = (int)state.Value.Balance, };
        }
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public async Task<IOT_Meta.GrpcService.Generated.Account> Deposit(IOT_Meta.GrpcService.Generated.Transaction transaction, ServerCallContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public async Task<IOT_Meta.GrpcService.Generated.Account> Withdraw(IOT_Meta.GrpcService.Generated.Transaction transaction, ServerCallContext context)
        {
